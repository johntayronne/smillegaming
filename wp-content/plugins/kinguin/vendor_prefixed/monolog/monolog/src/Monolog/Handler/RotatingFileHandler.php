 ...
 */
class RotatingFileHandler extends \ILKinguinVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \ILKinguinVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \ILKinguinVendor\Monolog\Utils::canonicalizePath($filename);
