 ...
 */
class MercurialProcessor implements \ILKinguinVendor\Monolog\Processor\ProcessorInterface
{
    private $level;
    private static $cache;
    public function __construct($level = \ILKinguinVendor\Monolog\Logger::DEBUG)
    {
