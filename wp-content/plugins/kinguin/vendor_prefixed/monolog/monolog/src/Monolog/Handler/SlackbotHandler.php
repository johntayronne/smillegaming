 ...
 */
class SlackbotHandler extends \ILKinguinVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \ILKinguinVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
