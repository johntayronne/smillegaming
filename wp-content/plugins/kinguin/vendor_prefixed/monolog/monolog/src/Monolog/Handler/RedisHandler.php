 ...
 */
class RedisHandler extends \ILKinguinVendor\Monolog\Handler\AbstractProcessingHandler
{
    private $redisClient;
    private $redisKey;
    protected $capSize;
     ...
     */
    public function __construct($redis, $key, $level = \ILKinguinVendor\Monolog\Logger::DEBUG, $bubble = \true, $capSize = \false)
    {
        if (!($redis instanceof \ILKinguinVendor\Predis\Client || $redis instanceof \Redis)) {
