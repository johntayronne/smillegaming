 ...
 */
class BrowserConsoleHandler extends \ILKinguinVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \ILKinguinVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
