...
<h2><?php 
echo \sprintf(\__('You are deactivating %s plugin.', 'kinguin'), $plugin_name);
?></h2>
...
<div class="wpdesk_tracker_deactivate">
	<div class="body">
		...
		<div class="panel active" data-panel-id="reasons">
			<h4><strong><?php 
\_e(' If you have a moment, please let us know why you are deactivating plugin (anonymous feedback):', 'kinguin');
?></strong></h4>
			<ul id="reasons-list">
                <li class="reason">
                    <label>
	            	<span>
                        ...
                        <span><?php 
\_e('The plugin suddenly stopped working', 'kinguin');
?></span>
                    </label>
                </li>
                <li class="reason">
	            	...
	            	<span>
                        ...
                        <span><?php 
\_e('The plugin broke my site', 'kinguin');
?></span>
                    </label>
                </li>
...
?>">
				...
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\_e('I only needed the plugin for a short period', 'kinguin');
?></span>
					</label>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\_e('I no longer need the plugin', 'kinguin');
?></span>
					</label>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\_e('It\'s a temporary deactivation. I\'m just debugging an issue.', 'kinguin');
?></span>
					</label>
				</li>
				<li class="reason has-input">
...
\_e('Kindly tell us the reason so we can improve', 'kinguin');
?>">
					</div>
				</li>
			</ul>
