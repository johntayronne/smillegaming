...
if (!\interface_exists('ILKinguinVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('ILKinguinVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \ILKinguinVendor\WPDesk_Translatable, \ILKinguinVendor\WPDesk_Buildable, \ILKinguinVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
