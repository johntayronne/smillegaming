 ...
 */
class InfoBuilder extends \ILKinguinVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function __construct(\ILKinguinVendor\WPDesk_Buildable $info)
    {
        $this->info = $info;
