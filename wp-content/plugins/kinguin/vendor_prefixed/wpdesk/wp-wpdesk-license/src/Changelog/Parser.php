...
namespace ILKinguinVendor\WPDesk\License\Changelog;

use ArrayObject;
use ILKinguinVendor\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \ILKinguinVendor\WPDesk\License\Changelog\Parser\Line($line);
