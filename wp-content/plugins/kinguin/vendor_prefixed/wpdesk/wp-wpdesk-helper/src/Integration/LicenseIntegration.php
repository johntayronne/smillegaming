...
use ILKinguinVendor\WPDesk\License\Page\LicensePage;
 ...
 */
class LicenseIntegration implements \ILKinguinVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /** @var LicensePage */
    ...
    {
        $plugin_registry = new \ILKinguinVendor\WPDesk\License\InstalledPlugins();
        $this->license_page = new \ILKinguinVendor\WPDesk\License\Page\LicensePage($plugin_registry);
