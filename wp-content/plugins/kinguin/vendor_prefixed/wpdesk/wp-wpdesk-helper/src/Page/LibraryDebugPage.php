 ...
 */
class LibraryDebugPage implements \ILKinguinVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function hooks()
    {
        \add_action('admin_menu', function () {
            ...
            \add_submenu_page($parent_slug, \__('Library report', 'kinguin'), \__('Library report', 'kinguin'), 'manage_options', 'wpdesk-helper-library-report', function () {
