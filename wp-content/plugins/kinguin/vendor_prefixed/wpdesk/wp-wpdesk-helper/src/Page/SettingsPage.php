...
namespace ILKinguinVendor\WPDesk\Helper\Page;
 ...
 */
class SettingsPage implements \ILKinguinVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    {
        \add_submenu_page('wpdesk-helper', \__('Settings', 'kinguin'), \__('Settings', 'kinguin'), 'manage_options', 'wpdesk-helper-settings', function () {
    ...
    private function handle_render_wpdesk_helper_settings()
    {
        ...
        <div class="wrap">
            <h1><?php 
        \_e('WP Desk Helper Settings', 'kinguin');
        ?></h1>
