...
if (!\interface_exists('ILKinguinVendor\\WPDesk_Requirement_Checker')) {
...
if (!\class_exists('ILKinguinVendor\\WPDesk_Basic_Requirement_Checker')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker implements \ILKinguinVendor\WPDesk_Requirement_Checker
    {
